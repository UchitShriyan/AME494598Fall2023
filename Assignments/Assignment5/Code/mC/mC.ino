...
const char* serverName = "http://54.237.120.47:8080/setValue";
...
void loop() {
    // Check if it's time to get data based on the timerDelay value.
    if (millis() - lastTime >= timerDelay) {
        // Update the last time we took a reading
        lastTime = millis();
